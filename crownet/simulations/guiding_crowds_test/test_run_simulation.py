...
if __name__=="__main__":
	...
	# test_4()
	# test_5()
	output_dir = os.path.abspath("tests/final_control_test_3/**")
	r = diff.create_dir_diff(output_dir, os.path.abspath("tests"))
	diff.diffdict_to_csv("tests/final_control_test_3/digest_all.csv", r)
