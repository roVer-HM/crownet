...
def visualize():
    with open(TEMP_FILE, "r") as f:
        ...
        fig.subplots_adjust(bottom=0.25, left=0.12, top=0.95, right=0.99, hspace=0)
        ...
        fig.supylabel("\nMean VRU cluster cardinality size\n+/- std. deviation", size=18, ha="center")
        fig.supxlabel(f"{PARAMETER_NAME} parameter in meters", size=18)
