...
RESULTS = "../results"
STUDY_NAME = "study_simple_velocity_difference_avg2s"
...
def visualize():
    with open(TEMP_FILE, "r") as f:
        ...
        for sli, sl in enumerate([[1, 11, 2], [3, 4, 5, 10]]):
            ...
            fig.savefig(f"fig/{PARAMETER_NAME}_{sli}_2.png")    
            fig.savefig(f"fig/{PARAMETER_NAME}_{sli}_2.svg")
            fig.savefig(f"fig/{PARAMETER_NAME}_{sli}_2.pdf")
            plt.show()
        ...
        fig.savefig(f"fig/{PARAMETER_NAME}_all2.png")    
        fig.savefig(f"fig/{PARAMETER_NAME}_all2.svg")
        fig.savefig(f"fig/{PARAMETER_NAME}_all2.pdf")
        plt.show()
