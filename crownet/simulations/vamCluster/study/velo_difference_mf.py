...
def visualize():
    with open(TEMP_FILE, "r") as f:
        ...
        for sli, sl in enumerate([[1, 11, 2], [3, 4, 5, 10]]):
            ...
            fig.savefig(f"fig/{PARAMETER_NAME}_{sli}_mf.png")    
            fig.savefig(f"fig/{PARAMETER_NAME}_{sli}_mf.svg")
            fig.savefig(f"fig/{PARAMETER_NAME}_{sli}_mf.pdf")
            plt.show()
        ...
        fig.savefig(f"fig/{PARAMETER_NAME}_all_mf.png")    
        fig.savefig(f"fig/{PARAMETER_NAME}_all_mf.svg")
        fig.savefig(f"fig/{PARAMETER_NAME}_all_mf.pdf")
        plt.show()
