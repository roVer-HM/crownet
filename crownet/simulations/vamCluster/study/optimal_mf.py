...
RESULTS = "../results"
STUDIES = [
    "study_mf_optimal_nocluster_fix",
    "study_mf_optimal_ind_fix",
    "study_mf_optimal_sma_fix",
    "study_mf_optimal_fix",
    "study_mf_optimal_gro_fix",
]
LABELS = [
    "No clustering",
    "Individual mobility",
...
def visualize():
    ...
    ax.axhline(11620, linestyle="dashed", label="No clustering", linewidth=1, color="black")
    ...
    for i in range(len(STUDIES)):
        ...
        if i ==0:
            ...
            ax.text(i + 1, median - 1500, f"Median: {median}\nReduction: {(1 - median / 11620) * 100:.{2}f} %", fontsize=14,
                    horizontalalignment="center",
                    verticalalignment='top', bbox=props)
    ...
    fig.savefig(f"fig/optimal_mf_all.png")    
    fig.savefig(f"fig/optimal_mf_all.svg")
    fig.savefig(f"fig/optimal_mf_all.pdf")
    ...
    fig.savefig(f"fig/optimal_mf_poserr_c.png")    
    fig.savefig(f"fig/optimal_mf_poserr_c.svg")
    fig.savefig(f"fig/optimal_mf_poserr_c.pdf")
