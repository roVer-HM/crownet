    ...
    par_var = [
        {
            "omnet": {  
                ...
                "*.pNode[*].app[1].app.mapCfg": mapCfg.copy("stepDist", 10.0),
                }
        },
        {
            "omnet": {  
                ...
                "sim-time-limit": t,
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfg.copy("stepDist", 25.0)
                }
        },
        {
            "omnet": {  
                ...
                "sim-time-limit": t,
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfg.copy("stepDist", 50.0)
                }
        },
    ]
