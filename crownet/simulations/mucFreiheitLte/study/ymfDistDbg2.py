...
def main(base_path):
    ...
    par_var = [
        {
            "omnet": {
                "extends": "ymfPlusDist_4s_1_new",
                "sim-time-limit": t,
                "seed-set": "195",
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy("stepDist", 2.0),
            }
        },
        {
            "omnet": {
                ...
                "seed-set": "195",
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy("stepDist", 5.0),
            }
        },
        {
            "omnet": {
                ...
                "seed-set": "195",
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy("stepDist", 7.0),
            }
        },
        {
            "omnet": {
                ...
                "seed-set": "195",
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy("stepDist", 15.0),
            }
        },
        {
            "omnet": {
                ...
                "seed-set": "195",
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy("stepDist", 50.0),
            }
        },
        {
            "omnet": {
