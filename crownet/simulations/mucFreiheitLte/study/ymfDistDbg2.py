    ...
    par_var = [
        {
            "omnet": {  
                ...
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 2.0),
                }
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 5.0)
                }
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 7.0)
                }
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 15.0)
                }
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 50.0)
                }
        },
        {
            "omnet": {  
