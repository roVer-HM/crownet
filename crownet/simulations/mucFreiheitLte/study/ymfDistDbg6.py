    ...
    par_var = [
        {
            "omnet": {
                ...
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy(
                    "stepDist", 90.0, "alpha", 0.5, "zeroStep", BoolValue.FALSE
                ),
            }
        },
        {
            "omnet": {
                ...
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy(
                    "stepDist", 90.0, "alpha", 0.5, "zeroStep", BoolValue.TRUE
                ),
            }
        },
        {
            "omnet": {
                ...
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy(
                    "stepDist", 150.0, "alpha", 0.5, "zeroStep", BoolValue.FALSE
                ),
            }
        },
        {
            "omnet": {
                ...
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy(
                    "stepDist", 150.0, "alpha", 0.5, "zeroStep", BoolValue.TRUE
                ),
            }
        },
        {
            "omnet": {
                ...
                "**.vadereScenarioPath": scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": mapCfgYmfDist.copy(
                    "stepDist", 150.0, "alpha", 0.75, "zeroStep", BoolValue.TRUE
                ),
            }
        },
        {
