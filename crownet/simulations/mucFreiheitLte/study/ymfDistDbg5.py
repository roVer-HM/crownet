    ...
    par_var = [
        {
            "omnet": {  
                ...
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 15.0, "alpha", 0.75, "zeroStep", BoolValue.FALSE),
                }
        ...
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 50.0, "alpha", 0.75, "zeroStep", BoolValue.FALSE)
                }
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 75.0, "alpha", 0.75, "zeroStep", BoolValue.FALSE)
                }
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 90.0, "alpha", 0.75, "zeroStep", BoolValue.FALSE)
                }
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_3source,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 90.0, "alpha", 0.75, "zeroStep", BoolValue.TRUE)
                }
        },
        {
            "omnet": {  
