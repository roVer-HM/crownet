...
def main(base_path):
    ...
    scenario_muc_004 = QString("vadere/scenarios/mf_004_template.scenario")
    t = UnitValue.s(400.0)
    # seed = "195"
    seed = "113"
    ...
    par_var = [
        {
            "omnet": {  
                "sim-time-limit": t,
                "seed-set" : seed,
                "**.vadereScenarioPath" : scenario_muc_004,
        ...
        },
        {
            "omnet": {  
                ...
                "**.vadereScenarioPath" : scenario_muc_004,
                "*.pNode[*].app[1].app.mapCfg": 
                    mapCfgYmfDist.copy("stepDist", 150.0, "alpha", 0.5, "zeroStep", BoolValue.FALSE, "mapTypeLog", QString("ymfPlusDistStep")),
