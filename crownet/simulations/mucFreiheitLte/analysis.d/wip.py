...
def make_interactive(sql):
    ...
    map = folium.Map([48.161701,11.5862764], tiles="Stamen Toner", zoom_start=18, max_zoom=22)
    HeatMapWithTime(
        data, 
        radius=10, 
        auto_play= True, 
        ...
        max_opacity = 1.0,
        # scale_radius= True,
        gradient={0.0: '#0000ff', .2: '#cc0033', .4: "#990066", .6: "#660099", .8: "#3300CC", 1: '#ff0000'}
    ).add_to(map)
