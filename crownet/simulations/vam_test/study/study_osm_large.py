...
def main(base_path):
    ...
    par_var = [
        {
            "omnet": { 
                "sim-time-limit": t, 
                "seed-set" : seed,
                "*.traci.launcher.sumoCfgBase": 'absFilePath("sumo/osm_large_map/hm_map.sumo.cfg")'
            },
        },
        {
            "omnet": { 
                "sim-time-limit": t,
                "seed-set" : seed, 
                "*.traci.launcher.sumoCfgBase": 'absFilePath("sumo/osm_large_map/hm_map_2.sumo.cfg")'
            },
        },
        {
            "omnet": { 
                "sim-time-limit": t,
                "seed-set" : seed, 
                "*.traci.launcher.sumoCfgBase": 'absFilePath("sumo/osm_large_map/hm_map_3.sumo.cfg")'
            },
        },
    ]
    ...
    env.copy_data(
        ...
        scenario_files=[
            os.path.abspath("../sumo/osm_large_map/hm_map_2.sumo.cfg"),
            os.path.abspath("../sumo/osm_large_map/sc3_100.rou.xml"),
            os.path.abspath("../sumo/osm_large_map/hm_map_3.sumo.cfg"),
            os.path.abspath("../sumo/osm_large_map/sc3_200.rou.xml")
            ]
        )
