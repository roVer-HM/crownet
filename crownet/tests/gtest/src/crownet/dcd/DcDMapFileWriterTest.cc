...
TEST_F(DcDMapFileWriterTest, print_header) {
  ...
  p.writeHeaderTo(out, "; ");
  std::string header =
      "simtime; x; y; count; measured_t; received_t; source; selection; selectionRank; "
      "sourceHost; sourceEntry; hostEntry; rsd_id; own_cell; owner_rsd_id\n";
...
TEST_F(DcDMapFileWriterTest, printglobal) {
  ...
  setSimTime(20.4); // time will bit be updated because old value hash higher time value
  ...
  std::string ret =
      "1.4; 1; 1; 2; 30; 30; 2; ; 1.79769e+308; 0; 100, 101\n"
      "1.4; 3; 3; 3; 32; 32; 2; ; 1.79769e+308; 1; 200, 201, 202\n"
      "1.4; 4; 4; 1; 34; 34; 2; ; 1.79769e+308; 0; 300\n"
      "10.4; 1; 1; 2; 30; 30; 2; ; 1.79769e+308; 0; 100, 101\n"
      "10.4; 3; 3; 3; 32; 32; 2; ; 1.79769e+308; 1; 200, 201, 202\n"
      "10.4; 4; 4; 2; 34; 34; 2; ; 1.79769e+308; 0; 300, 301\n"
      "20.4; 3; 3; 3; 32; 32; 2; ; 1.79769e+308; 1; 200, 201, 202\n"
      "20.4; 4; 4; 3; 34; 34; 2; ; 1.79769e+308; 0; 300, 301, 302\n";
...
TEST_F(DcDMapFileWriterNoGlobalEntryTest, print_all_valid) {
  ...
  RegularDcdMapValuePrinter p(mapFull);
  mapFull->setOwnerCell(GridCellID(3, 3));
  mapFull->setResourceSharingDomainId(12);
  ...
  update(mapFull, 5, 5, 333, 3, 30.4, 50); // set during update
  mapFull->computeValues(ymf_v);
  p.writeTo(out, "; ");
  ...
  std::string ret =
      "1.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "1.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; 12\n"
      "1.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "1.4; 6; 3; 5; 33; 33; 803; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "10.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "10.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; 12\n"
      "10.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "10.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "20.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "20.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; 12\n"
      "20.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "20.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "30.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "30.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; 12\n"
      "30.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; 12\n"
      "30.4; 5; 5; 3; 30.4; 30.4; 333; ymf; 0; 0; 0; 0; 50; 0; 12\n"  // set during update
      "30.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0; 12\n";
  ;
...
TEST_F(DcDMapFileWriterNoGlobalEntryTest, print_duplicate_selections) {
    ...
    mapFull->setOwnerCell(GridCellID(3, 3));
    mapFull->setResourceSharingDomainId(999);
    ...
    std::string ret =
            "1.4; 1; 1; 2; 30; 30; 3; ; 1.79769e+308; 0; 0; 0; -1; 0; 999\n"
            "1.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; 999\n"
            "1.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; 999\n"
            "1.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; 999\n"
            "1.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0; 999\n"
            "1.4; 6; 3; 5; 33; 33; 803; ymf; 0; 0; 0; 0; -1; 0; 999\n"
            "1.4; 6; 3; 7; 31; 31; 805; ; 1.79769e+308; 0; 0; 0; -1; 0; 999\n"
            "1.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0; 999\n"
            "10.4; 1; 1; 2; 30; 30; 3; ; 1.79769e+308; 0; 0; 0; -1; 0; 999\n"
            "10.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; 999\n"
            "10.4; 3; 3; 3; 32; 32; 3; ; 1.79769e+308; 0; 0; 0; -1; 1; 999\n" // << no 'ymf' here!
            "10.4; 3; 3; 10; 33.3; 33.3; 555; ymf; 0; 0; 0; 0; -1; 1; 999\n"
            "10.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; 999\n"
            "10.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0; 999\n"
            "10.4; 6; 3; 5; 33; 33; 803; ymf; 0; 0; 0; 0; -1; 0; 999\n"
            "10.4; 6; 3; 7; 31; 31; 805; ; 1.79769e+308; 0; 0; 0; -1; 0; 999\n"
            "10.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0; 999\n";
...
TEST_F(DcDMapFileWriterNoGlobalEntryTest, printall_all_valid) {
  ...
  RegularDcdMapAllPrinter p(mapFull);
  mapFull->setOwnerCell(GridCellID(3, 3));
  mapFull->setResourceSharingDomainId(-1);
  ...
  std::string ret =
      "1.4; 1; 1; 2; 30; 30; 3; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "1.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "1.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; -1\n"
      "1.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "1.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "1.4; 6; 3; 5; 33; 33; 803; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "1.4; 6; 3; 7; 31; 31; 805; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "1.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "10.4; 1; 1; 2; 30; 30; 3; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "10.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "10.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; -1\n"
      "10.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "10.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "10.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "10.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "20.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "20.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; -1\n"
      "20.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "20.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "20.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "20.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "30.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "30.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1; -1\n"
      "30.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "30.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n"
      "30.4; 5; 5; 3; 30.4; 30.4; 333; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "30.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0; -1\n"
      "30.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0; -1\n";
