...
TEST_F(DcDMapFileWriterTest, print_header) {
  ...
  std::string header =
      ...
      "sourceHost; sourceEntry; hostEntry; rsd_id; own_cell\n";
...
TEST_F(DcDMapFileWriterNoGlobalEntryTest, print_all_valid) {
  ...
  std::string ret =
      "1.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0\n"
      "1.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1\n"
      "1.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0\n"
      "1.4; 6; 3; 5; 33; 33; 803; ymf; 0; 0; 0; 0; -1; 0\n"
      "10.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0\n"
      "10.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1\n"
      "10.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0\n"
      "10.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0\n"
      "20.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0\n"
      "20.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1\n"
      "20.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0\n"
      "20.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0\n"
      "30.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0\n"
      "30.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1\n"
      "30.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0\n"
      "30.4; 5; 5; 3; 30.4; 30.4; 333; ymf; 0; 0; 0; 0; -1; 0\n"
      "30.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0\n";
  ;
...
TEST_F(DcDMapFileWriterNoGlobalEntryTest, print_duplicate_selections) {
    ...
    std::string ret =
            "1.4; 1; 1; 2; 30; 30; 3; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
            "1.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0\n"
            "1.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1\n"
            "1.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0\n"
            "1.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
            "1.4; 6; 3; 5; 33; 33; 803; ymf; 0; 0; 0; 0; -1; 0\n"
            "1.4; 6; 3; 7; 31; 31; 805; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
            "1.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
            "10.4; 1; 1; 2; 30; 30; 3; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
            "10.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0\n"
            "10.4; 3; 3; 3; 32; 32; 3; ; 1.79769e+308; 0; 0; 0; -1; 1\n" // << no 'ymf' here!
            "10.4; 3; 3; 10; 33.3; 33.3; 555; ymf; 0; 0; 0; 0; -1; 1\n"
            "10.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0\n"
            "10.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
            "10.4; 6; 3; 5; 33; 33; 803; ymf; 0; 0; 0; 0; -1; 0\n"
            "10.4; 6; 3; 7; 31; 31; 805; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
            "10.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0\n";
...
TEST_F(DcDMapFileWriterNoGlobalEntryTest, printall_all_valid) {
  ...
  std::string ret =
      ...
      "20.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1\n"
      "20.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0\n"
      "20.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
      "20.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0\n"
      "20.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
      "30.4; 1; 1; 4; 31; 31; 800; ymf; 0; 0; 0; 0; -1; 0\n"
      "30.4; 3; 3; 3; 32; 32; 3; ymf; 0; 0; 0; 0; -1; 1\n"
      "30.4; 4; 4; 2; 34; 34; 3; ymf; 0; 0; 0; 0; -1; 0\n"
      "30.4; 4; 4; 3; 32; 32; 801; ; 1.79769e+308; 0; 0; 0; -1; 0\n"
      "30.4; 5; 5; 3; 30.4; 30.4; 333; ymf; 0; 0; 0; 0; -1; 0\n"
      "30.4; 6; 3; 7; 31; 31; 805; ymf; 0; 0; 0; 0; -1; 0\n"
      "30.4; 6; 3; 9; 12; 12; 808; ; 1.79769e+308; 0; 0; 0; -1; 0\n";
