...
r2 = ropp.load_df('test-data/mf_D2D_1to2_Vadere_00/foo1.vec', override_existing_csv=False)
#%%
...
for idx, (_, s) in enumerate(delay.iterrows()):
    ...
    ax.plot(s['vectime'], s['vecvalue'], **ropp.plt_args(idx, lbl))
...
rcvd_snir: pd.DataFrame = r2.opp.by_name_module('rcvdSinr:vector', 'LTE_d2d_Vadere.eNB.lteNic.channelModel').iloc[0]
