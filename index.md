...
![Dense crowd in front of a bottleneck](ped_antenne.png "Dense crowd in front of a bottleneck" =250x)
...
![Communication for different types of coverage](coverage_szenarien_dense_ITS_en.png "Communication for different types of coverage" =250x)
